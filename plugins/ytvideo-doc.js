...
if (!args[0]) throw '*أدخل رابط فيديو يوتيوب*'
await m.reply(`*_يرجى الانتظار لتنزيل مستند الفيديو الخاص بك_*`)
try {
let qu = args[1] || '360'
let q = qu + 'p'
let v = args[0]
...
handler.command = /^ytmp4doc|ytvdoc|ytv|ytmp4|vdoc|ytmp4.2|ytv.2$/i
